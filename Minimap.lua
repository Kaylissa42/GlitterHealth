...
local button = CreateFrame("Button", "GlitterHealthMinimapButton", Minimap)
...
icon:SetTexture("Interface\\Icons\\INV_HeartOfAzeroth")
...
button:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine(WHITE_COLOR.."Ctrl+Left-Click: "..PINK_COLOR.."Drag to move")
    GameTooltip:Show()
end)
