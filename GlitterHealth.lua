...
local ROLEPLAY_MIN_VALUE = 0
local ROLEPLAY_MAX_VALUE = 100
local ROLEPLAY_BASE_HUNGER_RATE = 0.02
local ROLEPLAY_MOVING_HUNGER_RATE = 0.05
local ROLEPLAY_BASE_HYDRATION_RATE = 0.015
local ROLEPLAY_MOVING_HYDRATION_RATE = 0.04
local ROLEPLAY_MAX_MOVE_FACTOR = 2.0
local ROLEPLAY_CONSUME_DELTA = 33
local ROLEPLAY_BUTTON_GAP = 4
local ROLEPLAY_CONSUME_COOLDOWN = 180 -- seconds
...
local updateBars -- forward declaration for shared bar refresh
...
local THEMES = {
  Classic = {
    move={1.00,0.40,0.60}, steps={0.35,0.95,1.00}, exer={0.50,1.00,0.50}, walk={0.80,0.80,1.00},
    swim={0.40,0.70,1.00}, jump={1.00,0.85,0.40}, hunger={1.00,0.60,0.25}, hydration={0.30,0.75,1.00},
  },
  Pastel  = {
    move={1.00,0.60,0.75}, steps={0.60,1.00,1.00}, exer={0.65,1.00,0.70}, walk={0.75,0.70,1.00},
    swim={0.65,0.85,1.00}, jump={1.00,0.90,0.60}, hunger={1.00,0.80,0.60}, hydration={0.60,0.95,1.00},
  },
  Neon    = {
    move={1.00,0.10,0.40}, steps={0.10,1.00,1.00}, exer={0.10,1.00,0.10}, walk={0.40,0.40,1.00},
    swim={0.10,0.60,1.00}, jump={1.00,0.80,0.10}, hunger={1.00,0.40,0.10}, hydration={0.10,0.90,1.00},
  },
  Dark    = {
    move={0.95,0.25,0.45}, steps={0.20,0.80,0.85}, exer={0.30,0.85,0.40}, walk={0.55,0.55,0.85},
    swim={0.25,0.55,0.85}, jump={0.85,0.70,0.25}, hunger={0.85,0.55,0.30}, hydration={0.35,0.60,0.85},
  },
  Skyline = {
    move={0.80,0.30,0.65}, steps={0.25,0.70,0.85}, exer={0.30,0.80,0.55}, walk={0.35,0.55,0.85},
    swim={0.18,0.40,0.80}, jump={0.70,0.60,0.25}, hunger={0.85,0.55,0.35}, hydration={0.30,0.65,0.90},
  },
  Spectrum= {
    move={0.85,0.20,0.20}, steps={0.85,0.55,0.10}, exer={0.80,0.80,0.15}, walk={0.15,0.80,0.20},
    swim={0.15,0.45,0.85}, jump={0.55,0.25,0.80}, hunger={0.80,0.25,0.20}, hydration={0.20,0.55,0.85},
  },
  Sunset  = {
    move={0.85,0.35,0.20}, steps={0.85,0.60,0.28}, exer={0.80,0.52,0.28}, walk={0.80,0.45,0.35},
    swim={0.65,0.42,0.85}, jump={0.85,0.68,0.45}, hunger={0.95,0.55,0.25}, hydration={0.65,0.45,0.90},
  },
  Ocean   = {
    move={0.12,0.55,0.75}, steps={0.15,0.70,0.80}, exer={0.20,0.70,0.50}, walk={0.12,0.45,0.80},
    swim={0.08,0.32,0.72}, jump={0.20,0.65,0.85}, hunger={0.85,0.45,0.25}, hydration={0.10,0.55,0.80},
  },
  Forest  = {
    move={0.45,0.25,0.18}, steps={0.28,0.60,0.35}, exer={0.25,0.70,0.28}, walk={0.15,0.55,0.28},
    swim={0.20,0.42,0.50}, jump={0.55,0.48,0.25}, hunger={0.75,0.45,0.25}, hydration={0.25,0.55,0.45},
  },
  Candy   = {
    move={0.85,0.40,0.68}, steps={0.70,0.85,0.80}, exer={0.58,0.85,0.68}, walk={0.75,0.68,0.85},
    swim={0.62,0.70,0.85}, jump={0.85,0.70,0.58}, hunger={0.95,0.55,0.65}, hydration={0.60,0.85,0.95},
  }, -- default
  RainbowSparkle = {
    move={0.85,0.18,0.18}, steps={0.85,0.55,0.00}, exer={0.85,0.75,0.10}, walk={0.00,0.50,0.18},
    swim={0.18,0.35,0.70}, jump={0.50,0.18,0.60}, hunger={0.95,0.35,0.20}, hydration={0.25,0.55,0.95},
  },
  CottonCandy    = {
    move={0.50,0.65,0.95}, steps={0.90,0.50,0.70}, exer={0.78,0.80,0.85}, walk={0.55,0.75,0.95},
    swim={0.90,0.60,0.75}, jump={0.75,0.85,0.95}, hunger={0.95,0.60,0.65}, hydration={0.65,0.85,0.95},
  },
  Starburst      = {
    move={0.70,0.62,0.12}, steps={0.80,0.80,0.80}, exer={0.12,0.12,0.12}, walk={0.55,0.25,0.62},
    swim={0.32,0.32,0.32}, jump={0.70,0.60,0.15}, hunger={0.90,0.65,0.25}, hydration={0.45,0.55,0.90},
  },
  TwilightDream  = {
    move={0.75,0.18,0.48}, steps={0.42,0.18,0.52}, exer={0.18,0.32,0.72}, walk={0.60,0.28,0.52},
    swim={0.28,0.36,0.72}, jump={0.75,0.28,0.55}, hunger={0.85,0.35,0.45}, hydration={0.35,0.40,0.80},
  },
  BubblePop      = {
    move={0.80,0.70,0.08}, steps={0.80,0.32,0.60}, exer={0.24,0.48,0.80}, walk={0.80,0.45,0.65},
    swim={0.28,0.45,0.80}, jump={0.80,0.72,0.20}, hunger={0.95,0.55,0.35}, hydration={0.35,0.70,0.90},
  },
  MintyFresh     = {
    move={0.00,0.55,0.28}, steps={0.32,0.70,0.45}, exer={0.75,0.75,0.75}, walk={0.16,0.16,0.16},
    swim={0.48,0.78,0.58}, jump={0.28,0.64,0.40}, hunger={0.80,0.45,0.25}, hydration={0.35,0.75,0.65},
  },
  Starlight      = {
    move={0.55,0.16,0.65}, steps={0.75,0.75,0.75}, exer={0.16,0.16,0.16}, walk={0.48,0.48,0.48},
    swim={0.32,0.32,0.32}, jump={0.64,0.40,0.72}, hunger={0.85,0.35,0.55}, hydration={0.40,0.55,0.85},
  },
}
...
local defaults = {
  ...
  profile = {
    ...
    opacity = 1.0,
    barTexture = "Blizzard",
    show = { move=true, steps=true, exer=true, walk=true, swim=true, jump=true, hunger=true, hydration=true },
    textJustify = "CENTER",
    roleplayDividerGap = 12,
    hidden = false,
    buttonsPos = "Bottom",
  ...
  runtime = {
    ...
    roleplay = { hunger = 0, hydration = 100 },
  },
...
local function getTextJustify()
  local j = (DB and DB.profile and DB.profile.textJustify) or "CENTER"
  j = string.upper(j or "CENTER")
  if j ~= "LEFT" and j ~= "RIGHT" and j ~= "CENTER" then
    j = "CENTER"
  end
  return j
end

local function applyBarTextAlignment(holder)
  if not holder then return end
  local target = holder._rpBarHolder or holder
  if not target or not target.text then return end

  local justify = getTextJustify()
  local text = target.text
  local needsRefresh = (target._ghAppliedJustify ~= justify)

  if not target._ghAlignmentApplied or needsRefresh then
    target._ghAlignmentApplied = true
    target._ghAppliedJustify = justify

    text:ClearAllPoints()
    text:SetPoint("LEFT", target, "LEFT", 6, 0)
    text:SetPoint("RIGHT", target, "RIGHT", -6, 0)
    ...
    if needsRefresh then
      ...
      if current ~= nil then
        -- Briefly clear and restore (alpha guarded) so WoW recalculates alignment without a visible blink
        local alpha = text:GetAlpha()
        text:SetAlpha(0)
        text:SetText("")
    ...
    if needsRefresh and bar then
      local minV, maxV = bar:GetMinMaxValues()
      local value = bar:GetValue()
      local delta = (maxV - minV) * 0.002
      if delta == 0 then delta = 0.002 end
      local temp = value + delta
      if temp > maxV then temp = value - delta end
      if temp ~= value then
        bar:SetValue(temp)
        if C_Timer and C_Timer.After then
          local original = value
          C_Timer.After(0, function()
            if bar then bar:SetValue(original) end
          end)
        else
          bar:SetValue(value)
        end
...
local function applyAllBarTextAlignment()
  if not ui or not ui.moveBar then return end
  if ui.moveBar then applyBarTextAlignment(ui.moveBar) end
  if ui.stepBar then applyBarTextAlignment(ui.stepBar) end
  if ui.exerBar then applyBarTextAlignment(ui.exerBar) end
  if ui.walkBar then applyBarTextAlignment(ui.walkBar) end
  if ui.swimBar then applyBarTextAlignment(ui.swimBar) end
  if ui.jumpBar then applyBarTextAlignment(ui.jumpBar) end
  if ui.hungerBar then applyBarTextAlignment(ui.hungerBar) end
  if ui.hydrationBar then applyBarTextAlignment(ui.hydrationBar) end
end

local function updateRoleplayBarLayout(wrapper)
  if not wrapper or not wrapper._rpButton then return end
  local barHolder = wrapper._rpBarHolder or wrapper
  local btn = wrapper._rpButton
  local barH = clamp(DB.profile.barHeight or 18, 12, 30)
  local totalW = DB.profile.barWidth or 200
  local btnSize = math.max(12, (barH or 18) - 2)
  if btnSize > barH then btnSize = barH end
  local gap = ROLEPLAY_BUTTON_GAP
  local available = totalW - (btnSize + gap)
  local barW = math.max(60, available)

  wrapper:SetSize(totalW, barH)

  barHolder:ClearAllPoints()
  barHolder:SetPoint("LEFT", wrapper, "LEFT", 0, 0)
  barHolder:SetPoint("TOP", wrapper, "TOP", 0, 0)
  barHolder:SetPoint("BOTTOM", wrapper, "BOTTOM", 0, 0)
  barHolder:SetWidth(barW)
  barHolder:SetFrameLevel((wrapper:GetFrameLevel() or 0) + 1)

  btn:SetSize(btnSize, btnSize)
  btn:SetFrameLevel((barHolder:GetFrameLevel() or 1) + 5)
  btn:ClearAllPoints()
  local vOffset = math.floor(math.max(0, (barH - btnSize) * 0.5))
  btn:SetPoint("LEFT", barHolder, "RIGHT", gap, 0)
  btn:SetPoint("TOP", wrapper, "TOP", 0, -vOffset)

  applyBarTextAlignment(wrapper)
end

local function configureRoleplayBar(holder, iconCandidates, tooltip, onClick)
  if not holder then return nil end
  local parent = holder
  local btn = mkIconButton(parent, iconCandidates, tooltip, onClick)
  holder._rpButton = btn
  updateRoleplayBarLayout(holder)
  return btn
end

local ROLEPLAY_BUTTONS = {}
...
local function roleplayCooldownTable()
  DB.runtime = DB.runtime or {}
  DB.runtime.roleplayCooldowns = DB.runtime.roleplayCooldowns or {}
  return DB.runtime.roleplayCooldowns
end

local function clearRoleplayCooldown(key)
  roleplayCooldownTable()[key] = nil
end

local function roleplayCooldownRemaining(key)
  if not key then return 0 end
  local expiresAt = roleplayCooldownTable()[key] or 0
  local remaining = (expiresAt or 0) - nowSeconds()
...
local function cancelRoleplayButtonTicker(btn)
  if btn and btn._ghCooldownTicker then
    btn._ghCooldownTicker:Cancel()
    btn._ghCooldownTicker = nil
  end
end

local function setRoleplayButtonReady(btn)
  if not btn then return end
  cancelRoleplayButtonTicker(btn)
  btn:SetEnabled(true)
  btn:SetAlpha(1)
  if btn._ghCooldownText then
    btn._ghCooldownText:Hide()
  end
end

local function syncRoleplayButtonCooldown(btn, key)
  if not btn or not key then return end
  cancelRoleplayButtonTicker(btn)
  local remaining = roleplayCooldownRemaining(key)
  if remaining <= 0 then
    clearRoleplayCooldown(key)
    setRoleplayButtonReady(btn)
    return
  end
  ...
  if not btn._ghCooldownText then
    local txt = btn:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    txt:SetPoint("CENTER", btn, "CENTER", 0, 0)
    txt:SetTextColor(1, 0.85, 0.25)
    btn._ghCooldownText = txt
  end

  if btn._ghCooldownText then
    btn._ghCooldownText:SetText(math.ceil(remaining))
    btn._ghCooldownText:Show()
  end

  if C_Timer and C_Timer.NewTicker then
    btn._ghCooldownTicker = C_Timer.NewTicker(1, function()
      local left = roleplayCooldownRemaining(key)
      if left <= 0 then
        clearRoleplayCooldown(key)
        setRoleplayButtonReady(btn)
      else
        if btn._ghCooldownText then
          btn._ghCooldownText:SetText(math.ceil(left))
        end
      end
    end)
  end
...
local function refreshRoleplayCooldownButtons()
  if ROLEPLAY_BUTTONS.eat then syncRoleplayButtonCooldown(ROLEPLAY_BUTTONS.eat, "eat") end
  if ROLEPLAY_BUTTONS.drink then syncRoleplayButtonCooldown(ROLEPLAY_BUTTONS.drink, "drink") end
end

local function setupRoleplayButtonTooltip(btn, label, key)
  if not btn then return end
  btn:SetScript("OnEnter", function(self)
    if not GameTooltip then return end
    GameTooltip:SetOwner(self, "ANCHOR_TOP")
    GameTooltip:ClearLines()
    GameTooltip:AddLine(colorize(GH_COLOR, label))
    GameTooltip:AddLine(GH_dim("Click to "..label:lower()))
    local remaining = roleplayCooldownRemaining(key)
    if remaining > 0 then
      GameTooltip:AddLine(colorize("FF6666", string.format("Ready in %s", formatCooldown(remaining))))
    else
      GameTooltip:AddLine(colorize("66FF66", "Ready to use"))
    end
    GameTooltip:Show()
  end)
...
local function registerRoleplayButton(btn, key, label)
  if not btn or not key then return end
  ROLEPLAY_BUTTONS[key] = btn
  setupRoleplayButtonTooltip(btn, label, key)
  refreshRoleplayCooldownButtons()
end

local function setRoleplayCooldown(key)
  if not key then return end
  roleplayCooldownTable()[key] = nowSeconds() + ROLEPLAY_CONSUME_COOLDOWN
  refreshRoleplayCooldownButtons()
end

local function resizeRoleplayBars()
  updateRoleplayBarLayout(ui.hungerBar)
  updateRoleplayBarLayout(ui.hydrationBar)
  applyAllBarTextAlignment()
  refreshRoleplayCooldownButtons()
end

local function ensureRoleplayState()
  if not DB then return { hunger = 0, hydration = ROLEPLAY_MAX_VALUE } end
  DB.runtime = DB.runtime or {}
  DB.runtime.roleplay = DB.runtime.roleplay or {}
  local rp = DB.runtime.roleplay
  if type(rp.hunger) ~= "number" then rp.hunger = 0 end
  if type(rp.hydration) ~= "number" then rp.hydration = ROLEPLAY_MAX_VALUE end
  rp.hunger = clamp(rp.hunger, ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  rp.hydration = clamp(rp.hydration, ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  return rp
end

local function applyRoleplayDelta(hungerDelta, hydrationDelta)
  local rp = ensureRoleplayState()
  rp.hunger = clamp((rp.hunger or 0) + (hungerDelta or 0), ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  rp.hydration = clamp((rp.hydration or ROLEPLAY_MAX_VALUE) + (hydrationDelta or 0), ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  if updateBars then updateBars() end
end

function NS.RoleplayEat()
  local remaining = roleplayCooldownRemaining("eat")
  if remaining > 0 then
    print("|cFFFF77FFGlitterHealth|r: Eat is on cooldown ("..formatCooldown(remaining)..")")
    return
  end
  applyRoleplayDelta(-ROLEPLAY_CONSUME_DELTA, 0)
  setRoleplayCooldown("eat")
end

function NS.RoleplayDrink()
  local remaining = roleplayCooldownRemaining("drink")
  if remaining > 0 then
    print("|cFFFF77FFGlitterHealth|r: Drink is on cooldown ("..formatCooldown(remaining)..")")
    return
  end
  applyRoleplayDelta(0, ROLEPLAY_CONSUME_DELTA)
  setRoleplayCooldown("drink")
end
...
local function visibleBarsOrder()
  ...
  if sh.hunger then table.insert(order, ui.hungerBar) end
  if sh.hydration then table.insert(order, ui.hydrationBar) end
  return order
end

local function isRoleplayBar(bar)
  if not ui then return false end
  return bar == ui.hungerBar or bar == ui.hydrationBar
end

local function barsAreaHeight(order)
  local gap = clamp(DB.profile.barGap or 0, -6, 8)
  local rpGap = DB.profile.roleplayDividerGap or 12
  local total = 0
  local prev
  for _, bar in ipairs(order or {}) do
    if bar then
      if total > 0 then
        local extra = 0
        if isRoleplayBar(bar) and not isRoleplayBar(prev) then
          extra = rpGap
        end
        total = total + gap + extra
      end
      total = total + (DB.profile.barHeight or 18)
      prev = bar
    end
  end
...
local function updateFrameHeight()
  ...
  local barsH = barsAreaHeight(order)
...
local function relayoutBars()
  ...
  for i,bar in ipairs(order) do
    ...
    if i==1 then
      ...
      bar:SetPoint("TOP", prev, "BOTTOM", 0, -(gap + extraGap))
    end
    bar:Show()
  end
  for _,b in ipairs({ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar}) do
    local visible=false
    for _,v in ipairs(order) do if v==b then visible=true break end end
    b:SetShown(visible and (not DB.profile.hidden))
  end
  if ui.roleplayDivider then
    ui.roleplayDivider:Hide()
    local firstRP, prevBeforeRP
    for _,bar in ipairs(order) do
      if bar == ui.hungerBar or bar == ui.hydrationBar then
        if not firstRP then firstRP = bar end
      elseif not firstRP then
        prevBeforeRP = bar
      end
    end
    if firstRP and (DB.profile.show.hunger or DB.profile.show.hydration) and not DB.profile.hidden then
      ui.roleplayDivider:ClearAllPoints()
      local gap = rpGap
      local lineOffset = math.max(2, math.min(gap - 2, math.floor(gap * 0.35)))
      if prevBeforeRP then
        ui.roleplayDivider:SetPoint("TOPLEFT", prevBeforeRP, "BOTTOMLEFT", 0, -lineOffset)
        ui.roleplayDivider:SetPoint("TOPRIGHT", prevBeforeRP, "BOTTOMRIGHT", 0, -lineOffset)
      else
        ui.roleplayDivider:SetPoint("BOTTOMLEFT", firstRP, "TOPLEFT", 0, lineOffset)
        ui.roleplayDivider:SetPoint("BOTTOMRIGHT", firstRP, "TOPRIGHT", 0, lineOffset)
      end
      if ui.roleplayDivider.SetFrameLevel then
        local ref = prevBeforeRP or firstRP
        ui.roleplayDivider:SetFrameLevel((ref:GetFrameLevel() or 0) + 1)
      end
      ui.roleplayDivider:Show()
    end
  end
  resizeRoleplayBars()
  applyAllBarTextAlignment()
...
local function positionButtons()
  ...
  if (DB.profile.buttonsPos or "Bottom") == "Top" then
    ...
    ui.btnsContainer:SetPoint("TOPLEFT", ui.barsContainer, "BOTTOMLEFT", 0, -24)
    ui.btnsContainer:SetPoint("TOPRIGHT", ui.barsContainer, "BOTTOMRIGHT", 0, -24)
  ...
  if ui.wellStatsBtn and ui.barsContainer then
    ...
    if (DB.profile.buttonsPos or "Bottom") == "Top" then
      ui.wellStatsBtn:SetPoint("BOTTOM", ui.barsContainer, "TOP", 0, 4)  -- above bars with breathing room
    else
      ui.wellStatsBtn:SetPoint("TOP", ui.barsContainer, "BOTTOM", 0, -12)
    end
  end
...
local function setHidden(hide)
  ...
  if DB.profile.hidden then
    for _,b in ipairs({ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar}) do if b then b:Hide() end end
    if ui.roleplayDivider then ui.roleplayDivider:Hide() end
  else
    ...
    if ui.hungerBar then ui.hungerBar:SetShown(DB.profile.show.hunger) end
  if ui.hydrationBar then ui.hydrationBar:SetShown(DB.profile.show.hydration) end
    relayoutBars()
  end
...
local function buildFrame()
  ...
  local C = DB.profile.colors
  -- Order: Move > Steps > Exercise > Walk > Swim > Jump > Hunger > Hydration
  ...
  ui.hungerBar = CreateFrame("Frame", nil, ui.barsContainer)
  ui.hydrationBar = CreateFrame("Frame", nil, ui.barsContainer)
  ui.hungerBar:SetSize(DB.profile.barWidth, DB.profile.barHeight)
  ui.hydrationBar:SetSize(DB.profile.barWidth, DB.profile.barHeight)
  ui.roleplayDivider = CreateFrame("Frame", nil, ui.barsContainer, "BackdropTemplate")
  ui.roleplayDivider:SetFrameStrata("MEDIUM")
  ui.roleplayDivider:SetHeight(2)
  ui.roleplayDivider:SetBackdrop({ bgFile = "Interface\\Buttons\\WHITE8X8" })
  ui.roleplayDivider:SetBackdropColor(1,1,1,0.25)
  ui.roleplayDivider:Hide()
  ui.hungerBar._rpBarHolder = mkBar(ui.hungerBar, DB.profile.barWidth, DB.profile.barHeight, C.hunger)
  ui.hydrationBar._rpBarHolder = mkBar(ui.hydrationBar, DB.profile.barWidth, DB.profile.barHeight, C.hydration)
  ui.hungerBar._rpBarHolder:SetPoint("TOPLEFT", ui.hungerBar, "TOPLEFT", 0, 0)
  ui.hungerBar._rpBarHolder:SetPoint("BOTTOMLEFT", ui.hungerBar, "BOTTOMLEFT", 0, 0)
  ui.hydrationBar._rpBarHolder:SetPoint("TOPLEFT", ui.hydrationBar, "TOPLEFT", 0, 0)
  ui.hydrationBar._rpBarHolder:SetPoint("BOTTOMLEFT", ui.hydrationBar, "BOTTOMLEFT", 0, 0)
  ui.hungerBar.bar = ui.hungerBar._rpBarHolder.bar
  ui.hungerBar.text = ui.hungerBar._rpBarHolder.text
  ui.hydrationBar.bar = ui.hydrationBar._rpBarHolder.bar
  ui.hydrationBar.text = ui.hydrationBar._rpBarHolder.text
  ui.hungerEatBtn = configureRoleplayBar(ui.hungerBar,
    { 134052, 133971, 133972 },
    nil,
    function() NS.RoleplayEat() end)
  ui.drinkBtn = configureRoleplayBar(ui.hydrationBar,
    { 132796, 132800, 132794 },
    nil,
    function() NS.RoleplayDrink() end)
  registerRoleplayButton(ui.hungerEatBtn, "eat", "Eat")
  registerRoleplayButton(ui.drinkBtn, "drink", "Drink")
  applyAllBarTextAlignment()
  retextureBars()
...
local function recolorBars()
  ...
  ui.hungerBar.bar:SetStatusBarColor(unpack(C.hunger))
  ui.hydrationBar.bar:SetStatusBarColor(unpack(C.hydration))
  local o = clamp(DB.profile.opacity or 1, 0.0, 1.0)
  for _,h in ipairs({ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar}) do
    local frame = h and (h._rpBarHolder or h)
    if frame then
      local r,g,b = frame.bar:GetStatusBarColor()
      frame.bar:SetStatusBarColor(r,g,b, o)
      frame:SetBackdropColor(0,0,0, 0.5 * o)
      frame:SetBackdropBorderColor(1,1,1, 0.25 * o)
      frame.text:SetAlpha(1.0)
    end
  end
  retextureBars()
end
...
function retextureBars()
  ...
  for _, holder in ipairs({ ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar }) do
    local frame = holder and (holder._rpBarHolder or holder)
    if frame and frame.bar then
      frame.bar:SetStatusBarTexture(path)
    end
  end
...
local function updateBars_impl()
  ...
  local hunger = clamp(rp.hunger or 0, ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  local hydration = clamp(rp.hydration or ROLEPLAY_MAX_VALUE, ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  ...
  if DB.profile.show.hunger then
    ui.hungerBar.bar:SetValue(hunger / ROLEPLAY_MAX_VALUE)
    ui.hungerBar.text:SetText(string.format("Hunger: %d", safeint(hunger)))
  end
  if DB.profile.show.hydration then
    ui.hydrationBar.bar:SetValue(hydration / ROLEPLAY_MAX_VALUE)
    ui.hydrationBar.text:SetText(string.format("Hydration: %d", safeint(hydration)))
  end
...
-- Jump press detection (spacebar); counts each jump event with a short throttle guard
local JUMP_MODE_PRESS = true
local JUMP_PRESS_THROTTLE = 0.2

local function GH_OnJumpPressed()
  if not DB then return end

  -- Guard against counting when dead/ghost or transport/flying modes
  ...
  if UnitOnTaxi and UnitOnTaxi("player") then
    if DB.profile and DB.profile.debugJumps then
      print("|cFFFF77FFGlitterHealth|r: jump press ignored (taxi)")
    end
    return
  end
  ...
  if UnitInVehicle and UnitInVehicle("player") and not flying then
    if DB.profile and DB.profile.debugJumps then
      print("|cFFFF77FFGlitterHealth|r: jump press ignored (vehicle)")
    end
    return
  end
  ...
  if IsFalling and IsFalling() then
    if DB.profile and DB.profile.debugJumps then
      print("|cFFFF77FFGlitterHealth|r: jump press ignored (airborne)")
    end
    return
  end
  ...
  local now = GetTime()
  DB.runtime = DB.runtime or {}
  local last = DB.runtime.lastJumpPress
  local delta = (last and (now - last)) or nil
  if delta and delta >= 0 and delta < JUMP_PRESS_THROTTLE then
    if DB.profile and DB.profile.debugJumps then
...
local function tick(elapsed)
  ...
  do
    ...
    local moveFactor = 0
    if moving then
      moveFactor = clamp(speed / 7.0, 0, ROLEPLAY_MAX_MOVE_FACTOR)
    end
    local hungerRate = ROLEPLAY_BASE_HUNGER_RATE + (moveFactor > 0 and (ROLEPLAY_MOVING_HUNGER_RATE * moveFactor) or 0)
    local hydrationRate = ROLEPLAY_BASE_HYDRATION_RATE + (moveFactor > 0 and (ROLEPLAY_MOVING_HYDRATION_RATE * moveFactor) or 0)
    rp.hunger = clamp((rp.hunger or 0) + (elapsed * hungerRate), ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
    rp.hydration = clamp((rp.hydration or ROLEPLAY_MAX_VALUE) - (elapsed * hydrationRate), ROLEPLAY_MIN_VALUE, ROLEPLAY_MAX_VALUE)
  end

  if not JUMP_MODE_PRESS then
    -- Early guard: don't track or count while dead/ghost or transport/flying modes
    ...
    if not suppress then
      if UnitOnTaxi and UnitOnTaxi("player") then
        ...
        local mounted = IsMounted and IsMounted()
        local inVehicle = UnitInVehicle and UnitInVehicle("player")
        if (flying and (mounted or inVehicle)) or (inVehicle and not flying) then
          suppress = true
        end
      end
    end
    ...
    if suppress then
      ...
      elseif not falling and DB.runtime.airborne then
        ...
        local AIR_MIN, AIR_MAX = 0.18, 1.35   -- seconds
        local ASC_MIN          = 0.05         -- yards
        local DROP_MAX         = 0.40         -- yards
        ...
        local now = GetTime()
        local lastJump = DB.runtime and DB.runtime.lastJumpTime
        if lastJump then
          local since = now - lastJump
...
do
  ...
  eb:SetScript("OnEditFocusLost", function(self)
    ...
    dropdown(secA,"left","Bar Text Alignment",{"Left","Center","Right"},
      function()
        local j = (DB.profile.textJustify or "CENTER"):upper()
        if j == "LEFT" then return "Left" elseif j == "RIGHT" then return "Right" else return "Center" end
      end,
      function(v)
        DB.profile.textJustify = string.upper(v or "CENTER")
        if updateBars then updateBars() end
        applyAllBarTextAlignment()
        if C_Timer and C_Timer.After then
          C_Timer.After(0, applyAllBarTextAlignment)
        end
      end)
    ...
    do
      ...
      dropdown(
        ...
        slider(secA,"right","Bar Height",12,30,1,function() return DB.profile.barHeight or 18 end,function(v) DB.profile.barHeight=clamp(math.floor(v+0.5),12,30); for _,h in ipairs({ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar}) do if h then local w = h:GetWidth() or (DB.profile.barWidth or 200); h:SetSize(w, DB.profile.barHeight) end end; relayoutBars(); updateFrameHeight() end,"%d","%d")
    slider(secA,"right","Bars Width",160,360,2,function() return DB.profile.barWidth end,function(v) DB.profile.barWidth=math.floor(v+0.5); ui.frame:SetWidth(DB.profile.barWidth+20); for _,h in ipairs({ui.moveBar, ui.stepBar, ui.exerBar, ui.walkBar, ui.swimBar, ui.jumpBar, ui.hungerBar, ui.hydrationBar}) do if h then h:SetWidth(DB.profile.barWidth) end end; positionButtons() end,"%d","%d")
    ...
    check(secB,"left","Hunger (RP)","Shows the fictional hunger bar for roleplay.",tog("hunger"));
    check(secB,"right","Hydration (RP)","Shows the fictional hydration bar for roleplay.",tog("hydration"))
    sectionFinish(secB)
...
core:SetScript("OnEvent", function(self, event, arg1, arg2)
  if event=="ADDON_LOADED" and arg1==ADDON_NAME then
    ...
    ensureRoleplayState()
    GH_ClampGoals()
    DB.runtime.lastJumpPress = nil
    DB.runtime.lastJumpTime  = nil
    DB.runtime.jumpFallStartTime = nil
    DB.runtime.jumpStartZ = nil
    DB.runtime.airborne = false
